...
$(document).ready(()=>{
  ...
  let cheesePizza = new Pizza(pizzaName, pizzaSize, crustType, toppingType, pizzaQuantity, false);
  $("#size-price").text(cheesePizza.size + " " + cheesePiza.type + ": " + "Ksh. " + cheesePiza.priceBySize());
  $("#crust-price").text(cheesePiza.crust + ": " +  "Ksh. " + cheesePizza.crustPrice());
  $("#toppings-price").text(cheesePizza.toppings + " Toppings" + ": " + "Ksh. " + cheesePizza.toppingsPrice());
  $("#delivery-price").text("Delivery: " + cheesePizza.deliveryPrice());
  $("#total").text("Total: " + "Ksh. " + cheesePizza.totalPlusDelivery());
  });
});
